          ...
          <main>
                ...
                <div className="flex justify-center items-center">
                  <div className="left-[72px]- top-[216px]- absolute- z-20 flex-col justify-center items-start space-y-6 inline-flex">
                    <div className="w-full flex-col justify-center items-start gap-2 inline-flex">
                      <h1 className="lg:w-[60%] 2xl:w-[80%] font-montserrat text-white text-3xl md:text-4xl lg:text-5xl m-d:leading-normal  xl:text-6xl font-bold lg:leading-[80px]">Embark on a Journey of Knowledge</h1>
                      <p className="lg:w-[40%] 2xl:w-[70%] font-montserrat text-white text-xl md:text-2xl font-bold">Step into the World of Learning Adventure Fun with Our Interactive Quizzes</p>
                    </div>
                    <button  className='rounded-lg px-6 py-2.5 bg-white hover:bg-[#D5AAD5] hover:font-bold'>
                      <a href='/getStarted' className='text-primary text-sm leading-6 font-medium'>Get Started</a>
                    </button>
                  </div>
              ...
              <div className="my-20">
                <div className="lg:flex justify-between items-center md:gap-4 sm:grid sm:grid-cols-2 grid-cols-1 gap-2">
                  ...
                  <div className="relative rounded-3xl">
                    <Image className="border-y-2 border-gray1 border-x-2 rounded-3xl bg-gray1" src={require("../../public/Images/pizza.svg")} alt="pizza"></Image>
                    <div>
                      <div className="w-full absolute bottom-0 pt-4 pl-4 pb-3 text-gray bg-white border-b-2 border-gray1 border-x-2 rounded-b-3xl">
                        ...
                        <div className="gap-4 block sm:inline-flex justify-center items-center">
                          <div className="flex relative h-8 w-24 justify-center items-center gap-y-[-8px]">
                            <Image className="z-0 bg-[] absolute left-0" src={require('../../public/images/ellipse-10.svg')} alt="people-joined-img"></Image>
                            <Image className="z-10 absolute left-4" src={require('../../public/images/ellipse-8.svg')} alt="people-joined-img"></Image>
                            <Image className="z-20 absolute content-center" src={require('../../public/images/ellipse-9.svg')} alt="people-joined-img"></Image>
                            <Image className="z-30 absolute right-4" src={require('../../public/images/ellipse-11.svg')} alt="people-joined-img"></Image>
                            <Image className="z-40 absolute right-0" src={require('../../public/images/ellipse-12.svg')} alt="people-joined-img"></Image>
                          </div>
                  ...
                  <div className="relative pt-4 sm:pt-0 rounded-3xl">
                    ...
                    <div>
                      <div className="w-full absolute bottom-0 pt-4 pl-4 pb-3 text-gray bg-white border-b-2 border-gray1 border-x-2 rounded-b-3xl">
                        ...
                        <div className="gap-4 block sm:inline-flex justify-center items-center">
                          <div className="flex relative h-8 w-24 justify-center items-center gap-y-[-8px]">
                            <Image className="z-0 absolute left-0" src={require('../../public/images/ellipse-10.svg')} alt="people-joined-img"></Image>
                            <Image className="z-10 absolute left-4" src={require('../../public/images/ellipse-8.svg')} alt="people-joined-img"></Image>
                            <Image className="z-20 absolute content-center" src={require('../../public/images/ellipse-9.svg')} alt="people-joined-img"></Image>
                            <Image className="z-30 absolute right-4" src={require('../../public/images/ellipse-11.svg')} alt="people-joined-img"></Image>
                            <Image className="z-40 absolute right-0" src={require('../../public/images/ellipse-12.svg')} alt="people-joined-img"></Image>
            ...
            <div className="pt-7 px-6 sm:px-[72px] flex items-center justify-center flex-col">
              ...
              <div className="flex gap-6 overflow-x-auto scrollbar-hide">
                ...
                <Image alt="1st-theme" className="bg-yellow1 w- rounded-3xl" src={require('@/../public/Images/theme1.svg')}></Image>
                <Image alt="2nd-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme2.svg')}></Image>
                <Image alt="3rd-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme3.svg')}></Image>
                <Image alt="4th-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme4.svg')}></Image>
                <Image alt="5th-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme5.svg')}></Image>
                <Image alt="6th-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme6.svg')}></Image>
                <Image alt="7th-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme7.svg')}></Image>
                <Image alt="8th-theme" className="bg-yellow1 w-[348px] rounded-3xl" src={require('@/../public/Images/theme8.svg')}></Image>
              </div>
              <div className="flex flex-wrap gap-6 my-9 md:my-28 justify-center items-center">
                <button  className='border border-primary rounded-lg px-6 py-2.5  xl:px-8 xl:py-5  bg-primary hover:bg-primary-light'>
                  <Link href='/signup' className='text-white text-2xl font-medium md:font-bold'>Get Started</Link>
                </button>
            ...
            <div className="pt-7 xl:px-[72px] flex items-center justify-center flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-10  xl:gap-x-14`">
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-x-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/book.svg')} alt="book-icon"></Image>
                  <h3 className="text-center font-montserrat text-2xl sm:text-[32px] sm:leading-10 font-medium">Personality Test</h3>
                </div>
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/ranking.svg')} alt="quiz-competition-icon"></Image>
                  <h3 className="text-center font-montserrat text-2xl sm:text-[32px] sm:leading-10 font-medium">Quiz Competition</h3>
                </div>
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/task-square.svg')} alt="employees-test-icon"></Image>
                  <h3 className="text-center font-montserrat text-2xl sm:text-[32px] sm:leading-10 font-medium">Employees Test</h3>
                </div>
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/menu-board.svg')} alt="compliance-quiz-icon"></Image>
                  <h3 className="text-center font-montserrat text-2xl sm:text-[32px] sm:leading-10 font-medium">Compliance quiz</h3>
                </div>
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/file-notebook.svg')} alt="club-tests-icon"></Image>
                  <h3 className="text-center font-montserrat text-2xl sm:text-[32px] sm:leading-10 font-medium">Club Tests</h3>
                </div>
                <div className="bg-[#E6CCE6] rounded-lg px-8 py-12 sm:px-[52px] sm:pb-11 lg:pt-[124px] flex flex-col items-center justify-end gap-5 sm:gap-y-10">
                  <Image className="w-16 xl:w-[112px]" src={require('@/../public/Images/book-saved.svg')} alt="school-exams-icon"></Image>
            ...
            <div className="bg-[#BF80BF] h-full pt-16 pb-20  md:pb-32 px-6 lg:px-[72px] flex items-center justify-center flex-col">
              ...
              <div className="flex flex-wrap sm:flex-nowrap sm:flex-row h-full gap-4 sm:gap-2 w-full relative justify-center">
                <Image src={require('../../public/Images/player1.svg')} className="order-first w-5/12 sm:w-[28%]" alt="player1-icon"></Image>
                <div className="order-last sm:order-2 flex flex-col justify-end gap-2 w-full sm:w-[44%]">
                  <div className="flex gap-2 w-full">
                  <Image src={require('@/../public/Images/player2.svg')} className="w-[49%]" alt="player1-icon"></Image>
                  <Image src={require('@/../public/Images/player3.svg')} className="w-[49%]" alt="player1-icon"></Image>

                  </div>
                  <div className="flex gap-2 w-full">
                    <Image src={require('@/../public/Images/player5.svg')} className="w-[31.25%]" alt="player1-icon"></Image>
                    <Image src={require('@/../public/Images/player6.svg')} className="w-[31.785%]" alt="player1-icon"></Image>
                    <Image src={require('@/../public/Images/player7.svg')} className="w-[31.25%]" alt="player1-icon"></Image>
                  </div>
                </div>
            ...
            <div className="w-full py-28 px-8 lg:px-8 xl:px-[72px]">
              ...
              <div className="my-28 w-full flex flex-wrap xl:flex-nowrap gap-8 lg:gap-12 xl:gap-24 justify-center">
                ...
                <div className="rounded-2xl w-fit sm:w-5/12 lg:w-[28%] flex flex-col justify-center items-center shadow-[0_7px_29px_0px_rgba(100,100,111,0.2)] py-6 px-5">
                  <h2 className="font-montserrat text-center text-black text-2xl font-medium mb-6">A Great tool for Accessing Students</h2>
                  <p className="w-11/12 text-center text-black text-lg font-normal leading-6 mb-7">“Treeviah has been a great tool when it comes to accessing my students in live quizeIt has a really beautiful UI, When it comes to awesome support & building delightful software.</p>
                  <div className="p-2 flex-col justify-center items-center gap-1 inline-flex">
                    <Image alt="profile-photo" className="w-12 h-12 rounded-full border-2 border-primary" src={require('@/../public/Images/profilepic.svg')} />
                    <div className="flex-col justify-center items-center gap-1 flex">
                        <h4 className="text-primary font-montserrat text-2xl font-medium text-center">Troy Maxwelson</h4>
                        <p className="text-gray text-sm font-normal leading-normal">Administrator</p>
                      </div>
                      <div className="justify-center items-center gap-2 inline-flex">
                        <div className="w-6 h-6 justify-center items-center flex">
                          <Image alt="star-rating" src={require('@/../public/Images/star.svg')}></Image>
                        </div>
                        <div className="w-6 h-6 justify-center items-center flex">
                          <Image alt="star-rating" src={require('@/../public/Images/star.svg')}></Image>
                        </div>
            ...
            <div className=" w-full flex flex-col items-center pb-20">
              ...
              <div className=" w-11/12 flex flex-wrap gap-6 justify-center lg:justify-center items-center  lg:gap-x-[120px]">
                <Image alt="Flutter-Festivals-Eket" src={require('@/../public/Images/flutter.svg')}></Image>
                <Image alt="Women-Tech-Makers" src={require('@/../public/Images/wtm.svg')}></Image>
                <Image alt="Google Developers-Group" src={require('@/../public/Images/gdg.svg')}></Image>
            ...
            <div className="px-8 sm:px-[72px] pt-14 pb-16 bg-gradient-to-l from-[#40196D] from-[16%] via-[#6F077B] via-[57.29%] to-primary to-[99.54%]">
              <div>
                ...
                <div className="flex gap-x-9 mb-10">
                  <a href="#" className="hover:scale-110 ease-in-out duration-150 rounded-full shadow">
                    <Image className="ease-in-out duration-150" src={require("../../public/Images/fb.svg")} alt="facebook-icon"/>
                  </a>
                  <a href="#" className="hover:scale-110 ease-in-out duration-150 rounded-full shadow">
                    <Image className="ease-in-out duration-150" src={require("../../public/Images/twitter.svg")} alt="twitter-icon"/>
                  </a>
                  <a href="#" className="hover:scale-110 ease-in-out duration-150 rounded-full shadow">
                    <Image className="ease-in-out duration-150" src={require("../../public/Images/instagram.svg")} alt="instagram-icon"/>
                  </a>
                  <a href="#" className="hover:scale-110 ease-in-out duration-150 rounded-full shadow">
