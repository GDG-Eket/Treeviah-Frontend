    ...
    <div>
      ...
      <main>
              ...
              <div className="p-2 flex-col justify-center items-center gap-1 inline-flex">
                ...
                <div className="justify-center items-center gap-2 inline-flex">
                  <div className="w-6 h-6 justify-center items-center flex">
                    <Image alt="star-rating" src={Star}></Image>
                  </div>
                  <div className="w-6 h-6 justify-center items-center flex">
                    <Image alt="star-rating" src={Star}></Image>
                  </div>
        ...
        <section className=" w-full flex flex-col items-center pb-20">
          <div className="flex flex-wrap justify-center items-center gap-2 mb-10">
            <div className="flex items-center gap-0.5">
              <Image alt="t-reeviah" src={Tlogo2}></Image>
          ...
          <div className=" w-11/12 flex flex-wrap gap-6 justify-center lg:justify-center items-center  lg:gap-x-[120px]">
            <Image alt="Flutter-Festivals-Eket" src={Flutter}></Image>
            <Image alt="Women-Tech-Makers" src={WTM}></Image>
            <Image alt="Google Developers-Group" src={GDG}></Image>
            <Image alt="Africinnovate" src={Africinnovate}></Image>
          </div>
        </section>
        {/* connect */}
        ...
        <div className="px-[72px] py-7 flex gap-6">
          <a href="#">
            <Image alt="Get from Google Playstore" src={Playstore}></Image>
          </a>
          <a href="#">
            <Image alt="Get from Appstore" src={Appstore}></Image>
          </a>
        </div>
        <LandingFooter />
      </main>
