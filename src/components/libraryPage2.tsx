      ...
      <div className="flex flex-col lg:flex-row max-w-[100%] w-full justify-start gap-8 lg:gap-8">
        ...
        <span className="">
          ...
          <div className="flex mt-[10px] justify-between">
            <h2 className="font-bold text-[20px] text-black">Virtual Reality</h2>
            <button className="my-[5px] border border-none bg-purple-300 text-primary px-[5px] py-[5px] rounded-[5px] text-[11px]">Result Analysis</button>
          </div>
          <div>
          <div className="flex justify-between">
            <span className="py-[10px] text-primary text-[14px] font-bold">Quiz played</span>
            <button className=" flex my-[7px] border border-primarylight bg-white px-[15px] pt-[7px] gap-[3px] rounded-[5px] text-[11px]"><BsPencil/> Edit</button>
        </div>
        <span className="text-[12px] font-light text-slate-400">6 players - 1 Host</span>
        <div className="flex gap-4">
      <div className="flex flex-col">
        {column1.map((Ellipse) => (
          <span key={Ellipse.id} className="flex mt-[8px] md:mt-[15px] gap-[5px] md:gap-[10px]">
            <span className="">
              <Image
                src={Ellipse.url}
                alt={Ellipse.alt}
