  ...
  return (
    <section className=" flex gap-0 flex-col h-screen md:pt-8 md:px-20 ">
      <div className="flex justify-between py-5 ml-12 md:ml-0">
        <h3 className="hidden md:flex text-primary text-[20px] font-semibold">
        ...
        <div className="relative">
          <div className="relative ">
            ...
            <span className="text-[18px] relative text-primary border-b-4 border-primary z-10">
              Privacy Tools
            </span>
          </div>
          <div className="absolute inset-0 border-b-2 border-zinc-300 transform translate-x-[20px]"></div>
          <div className="absolute inset-0 border-b-2 border-zinc-300 transform -translate-x-[25px]"></div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex justify-between gap-12">
            ...
            <span className="md:hidden text-primary"><IoMdArrowDropdown/></span>
          </div>
        </div>
        <div className="flex justify-between">
      ...
      <div className="flex flex-col gap-2 pb-10 mt-6">
      ...
      <div className="md:hidden flex flex-row justify-center items-center gap-[10px] mt-12">
        <button className="py-[6px] px-[30px] text-primarylight  border bg-white border-primarylight rounded-[10px]">
          Cancel
        </button>
        <button className="py-[6px] px-[33px] bg-primarylight text-white rounded-[10px]">
          Edit
        </button>
      </div>
    </section>
