    ...
    <div className="flex flex-col md:flex-row gap-5 md:gap-12 border border-zinc-300">
      ...
      <div className="flex flex-col justify-between md:ml-auto">
        ...
        <div className="flex gap-[10px] m-3">
          ...
          <button className=" border border-primary text-primarylight text-[11px] px-[18px] py-[3px] bg-white rounded-[5px]">
            Edit
          </button>
          <button className=" border bg-primary text-white text-[11px] px-[18px] py-[3px] rounded-[5px]">
            Start
          </button>
        </div>
      </div>
