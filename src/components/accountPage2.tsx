    ...
    <section className='h-screen'>
      ...
      <div className=' h-[150px] w-[150px] mb-12 md:mb-5 ml-[2%]'>
          ...
          <div className='flex flex-row gap-3 items-center justify-center mt-3'>
            <button className='text-primarylight w-[100px] h-[35px] border border-primary rounded-md'>Cancel</button>
            <button className='bg-primary text-white w-[100px] h-[35px] rounded-md'>Save</button>
          </div>
        </form>
    </div>
    </section>
