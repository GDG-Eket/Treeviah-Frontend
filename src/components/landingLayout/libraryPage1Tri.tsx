        ...
        <div className="flex flex-col justify-between flex-grow">
          ...
          <div className="flex justify-between">
            <div className="flex ">
              ...
              <span className="ml-5 text-primary font-semibold text-[18px]">
                <HiOutlineUserCircle />
              </span>
            ...
            <div className="flex gap-4 ml-auto">
              ...
              <div className="mx-5">
                <button className="mr-4 border border-primary text-primary-light text-[11px] px-[18px] py-[3px] bg-white rounded-[5px]">
                  Edit
                </button>
                <button className="mr-2 border bg-primary text-white text-[11px] px-[18px] py-[3px] rounded-[5px]">
                  Start
                </button>
              </div>
            </div>
